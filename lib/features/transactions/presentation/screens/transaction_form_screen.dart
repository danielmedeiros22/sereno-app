...
class _TransactionFormScreenState extends ConsumerState<TransactionFormScreen> {
  ...
  Color get _activeColor => _type == 'income' ? AppColors.income : AppColors.expense;
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          TextButton(
            onPressed: _save,
            child: Text('Salvar', style: TextStyle(color: _activeColor, fontWeight: FontWeight.w600)),
          ),
        ],
      ),
  ...
  Widget _buildDatePicker(ThemeData theme) {
    final formatted = DateFormat("EEEE, d 'de' MMMM", 'pt_BR').format(_date);
      ...
      children: _filteredCategories.map((cat) {
        ...
        return GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color: active ? _activeColor.withValues(alpha: 0.15) : theme.colorScheme.surface,
              borderRadius: BorderRadius.circular(12),
              border: Border.all(
